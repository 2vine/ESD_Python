...
#####################IARP poisoning attack#####################

def arp_scap(interface, target, interval=10.0):
...
if __name__ == "__main__":
    ...
    try:
        print("[*] Starting the ARP attack...")
        arp_scap(args["interface"], args["target"], args["interval"])
    except IOError:
        sysexit("[!] Interface doesn't exist")
    except KeyboardInterrupt:
        print("\n[*] Stopping the ARP  attack")